...
/**
 * A class for testing the add method of class Operation
 *
 * @author Anna Rývová
...
class SubtractTest extends TestCase {
    ...
    public function testBothParamsAreInt(): void {
        ...
        $expected = (new FractionFactory())->createFraction(-1, 1);
        $actual = self::$operation::subtract($number1, $number2);
    ...
    public function testBothParamsAreFraction(): void {
        $fraction1 = new Fraction(3, 4, true);
        $fraction2 = new Fraction(2, 3, true);

        $expected = new Fraction(1, 12, true);
        $actual = self::$operation::subtract($fraction1, $fraction2);
    ...
    public function testBothParamsAreMixedFraction(): void {
        ...
        $fraction2 = new MixedFraction(2, 2, 3, true);

        $expected = new MixedFraction(-1, 1, 4, true);
        $actual = self::$operation::subtract($fraction1, $fraction2);
    ...
    public function testBothParamsAreFloat(): void {
        ...
        $expected = new MixedFraction(-1, 31, 66, true);
        $actual = self::$operation::subtract($number1, $number2);
    ...
    public function testBothParamsAreMixedFractionWithOnlyWholePart(): void {
        $fraction1 = new MixedFraction(3, null, null, true);
        $fraction2 = new MixedFraction(-5, null, null, true);

        $expected = new MixedFraction(8, null, null, true);
        $actual = self::$operation::subtract($fraction1, $fraction2);
    ...
    public function testNumber1IsIntAndNumber2IsFraction(): void {
        ...
        $expected = new MixedFraction(6, 2, 7, true);
        $actual = self::$operation::subtract($number1, $number2);
    ...
    public function testNumber1IsIntAndNumber2IsMixedFraction(): void {
        ...
        $expected = new MixedFraction(3, 1, 8, true);
        $actual = self::$operation::subtract($number1, $number2);
    ...
    public function testNumber1IsFractionAndNumber2IsMixedFraction(): void {
        ...
        $expected = new MixedFraction(-2, 46, 63, true);
        $actual = self::$operation::subtract($number1, $number2);
    ...
    public function testNumber1IsMixedFractionAndNumber2IsFraction(): void {
        ...
        $number2 = new Fraction(1, 3, true);

        $expected = new MixedFraction(1, null, null, true);
        $actual = self::$operation::subtract($number1, $number2);
    ...
    public function testBothParamsAreFractionFirstParamHasNegativeNumerator(): void {
        ...
        $expected = new Fraction(-3, 5, true);
        $actual = self::$operation::subtract($number1, $number2);
    ...
    public function testBothParamsAreFractionFirstParamHasNegativeNumeratorAndNegativeDenominator(): void {
        ...
        $expected = new Fraction(1, 5, true);
        $actual = self::$operation::subtract($number1, $number2);
